...
const Mailing: React.FC<MailingProps> = ({ withTitle }) => {
  return (
    <div className="flex flex-col w-full items-center gap-8 lg:flex-row lg:justify-between">
      ...
      <form className="shrink-0 max-w-[445px] flex flex-col gap-4 w-full md:drop-shadow-[10px_10px_10px_rgba(54,83,107,0.25)] md:flex-row md:gap-0 relative lg:mt-[21px] lg:drop-shadow-[10px_10px_15px_rgba(54,83,107,0.25)]">
        <input
          type="email"
